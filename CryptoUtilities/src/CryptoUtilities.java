...
public final class CryptoUtilities {
    ...
    public static void reduceToGCD(NaturalNumber n, NaturalNumber m) {
        ...
        NaturalNumber remainder = n.newInstance();
        if (!m.isZero()) {
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
         ...
         */
        // Use the fast-powering algorithm with modulo m
        ...
        // While loop to calculate the power using fast powering algorithm
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        final NaturalNumber2 two = new NaturalNumber2(2);
        final NaturalNumber2 one = new NaturalNumber2(1);
        boolean check = true;
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        int quota = 50;
        int index = 0;
        while (index < quota && check == true) {
            NaturalNumber nCopy = new NaturalNumber2(n);
            nCopy.decrement();
            NaturalNumber randomNum = new NaturalNumber2(randomNumber(n));

            randomNum.increment();

            if (isWitnessToCompositeness(randomNum, nCopy)) {
                check = false;
            }
            index++;
        }
